...
//--- Sumbit handler ------------------------------------------------------------------------------------------------------------
async function submitHandler (form, e) {
  e.preventDefault();
...
function validateForm(form) {
  ...
  form.querySelectorAll("input, textarea").forEach((inputField) => {
    if (inputField.closest("#hcaptcha-widget")) return; // do nothing for hcaptcha widget
    //--- add event listener ----------------- ------------------------------------------------------------------------------------
...
//--- Input validation logic function ---------------------------------------------------------------------------------------------
...
//--- Input validation show function ----------------------------------------------------------------------------------------------
function showFieldError(inputField, message) {
  ...
  inputField.insertAdjacentHTML(
    "afterend",
    `
    <p role="alert" class="field-error text-body-sm-style text-error animate-fade-in">${message}</p>
  `,
  );
}

//--- Input validation clear function ---------------------------------------------------------------------------------------------
...
export function initContact() {
  ...
  form.addEventListener("submit", (e) => submitHandler(form, e));
}
